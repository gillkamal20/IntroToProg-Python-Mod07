...
#   kamal,05/29/2024,Created Script
# # ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    # Creating property for first name
    @property
    ...
    # Creating property for last name
...
# Creating a Student class the inherits from the Person class
class Student(Person):
    ...
    # adding the setter for course_name
...
class FileProcessor:
    ...
    Kamal,05.29.2030,Created Class for processing file
    """
    ...
    def read_data_from_file(file_name: str, student_data: list[Student]) -> list[Student]:
        ...
        ChangeLog: (Who, When, What)
        kamal,05.29.2030,Created function to read data from a json file
        ...
        try:
            ...
            if file is not None and file.closed == False:
                file.close()
        # To convert list of dictionary to Student
    ...
    def write_data_to_file(file_name: str, student_data: list[Student]):
        ...
        for student in student_data:
            file_data.append({'first_name': student.first_name, 'second_name': student.last_name, 'course_name': student.course_name})
